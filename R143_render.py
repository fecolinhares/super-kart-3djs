...
blend=os.path.join(job,'assets/hero-kart-v2/R143/hero-kart-v2-R143.blend')
out=os.path.join(job,'assets/hero-kart-v2/R143/renders'); os.makedirs(out,exist_ok=True)
view='beauty'
