...
blend=os.path.join(job,'assets/hero-kart-v2/R144/hero-kart-v2-R144.blend')
out=os.path.join(job,'assets/hero-kart-v2/R144/renders'); os.makedirs(out,exist_ok=True)
view='beauty'
