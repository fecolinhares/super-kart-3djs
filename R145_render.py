...
blend=os.path.join(job,'assets/hero-kart-v2/R145/hero-kart-v2-R145.blend')
out=os.path.join(job,'assets/hero-kart-v2/R145/renders'); os.makedirs(out,exist_ok=True)
view='beauty'
