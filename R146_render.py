...
blend=os.path.join(job,'assets/hero-kart-v2/R146/hero-kart-v2-R146.blend')
out=os.path.join(job,'assets/hero-kart-v2/R146/renders'); os.makedirs(out,exist_ok=True)
view='beauty'
