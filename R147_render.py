...
blend=os.path.join(job,'assets/hero-kart-v2/R147/hero-kart-v2-R147.blend')
out=os.path.join(job,'assets/hero-kart-v2/R147/renders'); os.makedirs(out,exist_ok=True)
view='beauty'
