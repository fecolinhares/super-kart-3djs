...
blend=os.path.join(job,'assets/hero-kart-v2/R148/hero-kart-v2-R148.blend')
out=os.path.join(job,'assets/hero-kart-v2/R148/renders'); os.makedirs(out,exist_ok=True)
view='beauty'
