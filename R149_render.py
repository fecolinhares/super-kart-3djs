...
blend=os.path.join(job,'assets/hero-kart-v2/R149/hero-kart-v2-R149.blend')
out=os.path.join(job,'assets/hero-kart-v2/R149/renders'); os.makedirs(out,exist_ok=True)
view='beauty'
