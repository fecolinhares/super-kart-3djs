...
blend=os.path.join(job,'assets/hero-kart-v2/R150/hero-kart-v2-R150.blend')
out=os.path.join(job,'assets/hero-kart-v2/R150/renders'); os.makedirs(out,exist_ok=True)
view='beauty'
