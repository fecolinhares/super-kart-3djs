...
blend=os.path.join(job,'assets/hero-kart-v2/R151/hero-kart-v2-R151.blend')
out=os.path.join(job,'assets/hero-kart-v2/R151/renders'); os.makedirs(out,exist_ok=True)
view='beauty'
