...
blend=os.path.join(job,'assets/hero-kart-v2/R152/hero-kart-v2-R152.blend')
out=os.path.join(job,'assets/hero-kart-v2/R152/renders'); os.makedirs(out,exist_ok=True)
view='beauty'
