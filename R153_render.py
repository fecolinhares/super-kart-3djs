...
blend=os.path.join(job,'assets/hero-kart-v2/R153/hero-kart-v2-R153.blend')
out=os.path.join(job,'assets/hero-kart-v2/R153/renders'); os.makedirs(out,exist_ok=True)
view='beauty'
