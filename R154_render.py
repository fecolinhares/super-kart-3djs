...
blend=os.path.join(job,'assets/hero-kart-v2/R154/hero-kart-v2-R154.blend')
out=os.path.join(job,'assets/hero-kart-v2/R154/renders'); os.makedirs(out,exist_ok=True)
view='beauty'
