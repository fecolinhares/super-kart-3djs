...
blend=os.path.join(job,'assets/hero-kart-v2/R156/hero-kart-v2-R156.blend')
out=os.path.join(job,'assets/hero-kart-v2/R156/renders'); os.makedirs(out,exist_ok=True)
view='beauty'
