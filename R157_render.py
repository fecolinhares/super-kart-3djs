...
blend=os.path.join(job,'assets/hero-kart-v2/R157/hero-kart-v2-R157.blend')
out=os.path.join(job,'assets/hero-kart-v2/R157/renders'); os.makedirs(out,exist_ok=True)
view='beauty'
