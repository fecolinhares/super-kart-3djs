#!/usr/bin/env python3
"""Build Super Kart Hero V2 R117 from a corrected authored parametric topology.
...
def parse_args():
    ...
    p.add_argument("--revision", default="R117")
...
def main():
    ...
    out=os.path.abspath(args.output or os.path.join(os.path.dirname(__file__), "hero-kart-v2-R117.blend")); os.makedirs(os.path.dirname(out),exist_ok=True)
