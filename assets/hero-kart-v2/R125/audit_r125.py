...
def main():
    blend=os.path.join(os.path.dirname(os.path.abspath(__file__)), "hero-kart-v2-R125.blend"); output=os.path.join(os.path.dirname(os.path.abspath(__file__)), "technical-audit.json"); bpy.ops.wm.open_mainfile(filepath=blend)
