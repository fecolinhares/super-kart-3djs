...
job=os.path.dirname(os.path.abspath(__file__)); blend=os.path.join(job,'hero-kart-v2-R82.blend'); out=os.path.join(job,'independent-verifier.json')
...
checks={
 'revision_marker': sc.get('review_revision')=='R82',
 'local_windshield_present': count('WindshieldDeflector_R82')==1,
 'two_mount_meshes': count('WindshieldSupport_')==2,
 'two_sockets': count('WindshieldSocket_L_R82')==1 and count('WindshieldSocket_R_R82')==1,
 'steering_pivot_present': count('SteeringPivot_R82')==1,
