...
job=os.path.dirname(os.path.abspath(__file__)); blend=os.path.join(job,'hero-kart-v2-R82.blend'); out=os.path.join(job,'technical-audit.json')
bpy.ops.wm.open_mainfile(filepath=blend)
report={'revision':'R82','blender':bpy.app.version_string,'blend':blend,'collections':{},'materials':[m.name for m in bpy.data.materials],'uv':{},'mounts':[],'sockets':[],'pivots':[]}
