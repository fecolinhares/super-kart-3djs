...
box("SP_Lf", 0.06,0.42,  0.26,0.52, 0.15,0.30)
box("SP_Rf", 0.06,0.42, -0.52,-0.26, 0.15,0.30)
box("SP_Lr",-0.66,0.06,  0.26,0.50, 0.15,0.52)
box("SP_Rr",-0.66,0.06, -0.50,-0.26, 0.15,0.52)
...
for sy,sn in ((1,"L"),(-1,"R")):
    box("P_Thigh"+sn,-0.20,0.34, sy*0.11-0.09, sy*0.11+0.09, 0.28,0.44)
...
box("P_Visor",-0.62,-0.54, -0.11,0.11, 0.70,0.80)
...
cil("R_Exh1",-1.16,0,0.40,0.080,0.34,(0,math.radians(90),0)); cil("R_Exh2",-1.16,0.20,0.40,0.080,0.34,(0,math.radians(90),0)); cil("R_Exh3",-1.16,-0.20,0.40,0.080,0.34,(0,math.radians(90),0))
...
bpy.ops.wm.save_as_mainfile(filepath='/opt/blender-runner/outputs/B011.blend')
print('###B010### ok')
