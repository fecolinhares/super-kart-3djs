...
# RODAS
DF,DR,WDF,WDR=0.460,0.598,0.200,0.260; TF,TR=0.80,0.98; xf,xr=0.70,-0.60
...
box("C_Floor",-0.86,0.62, -0.26,0.26, 0.13,0.22)
...
bpy.ops.wm.save_as_mainfile(filepath='/opt/blender-runner/outputs/B013.blend')
print('###B010### ok')
