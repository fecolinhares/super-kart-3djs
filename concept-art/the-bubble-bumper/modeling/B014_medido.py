...
# RODAS
DF,DR,WDF,WDR=0.407,0.407,0.200,0.300; TF,TR=0.78,1.00; xf,xr=0.355,-0.844
...
box("C_Floor",-0.86,0.62, -0.26,0.26, 0.18,0.28)
...
cil("R_Axle",-0.844,0,DR/2,0.045,1.06,(0,math.radians(90),0))
...
bpy.ops.wm.save_as_mainfile(filepath='/opt/blender-runner/outputs/B014.blend')
print('###B010### ok')
