...
box("C_NoseA",0.60,0.84, -0.22,0.22, 0.24,0.36)
box("C_NoseB",0.84,0.98, -0.18,0.18, 0.24,0.32)
box("C_NoseC",0.98,1.08, -0.14,0.14, 0.24,0.30)
# PARA-CHOQUE em C (tubo) — 3 cilindros
cil("B_Top",1.02,0,0.22,0.038,1.02)
cil("B_ArmL",0.86, 0.48,0.22,0.038,0.36,(0,math.radians(90),0))
cil("B_ArmR",0.86,-0.48,0.22,0.038,0.36,(0,math.radians(90),0))
# PILOTO: tronco capsula inclinada + 2 bracos + volante toroide + coxa/canela/bota por lado + capacete c/ viseira
box("P_Torso",-0.68,-0.46, -0.19,0.19, 0.44,0.78, rot=(0,math.radians(-50),0))
...
box("P_Hips",-0.52,-0.20, -0.21,0.21, 0.24,0.50)
esf("P_Head",(-0.62,0,0.80),0.150,0.150,0.150)
box("P_Visor",-0.630,-0.575, -0.140,0.140, 0.690,0.800)
box("P_Seat",-0.92,-0.78, -0.23,0.23, 0.30,0.72, rot=(0,math.radians(-18),0))
# TRASEIRA: motor + 3 escapes + eixo + para-choque em U vazado
box("R_Motor",-0.98,-0.72, -0.22,0.22, 0.24,0.44)
cil("R_Exh1",-1.06,0.14,0.44,0.055,0.24,(0,math.radians(74),0)); cil("R_Exh2",-1.06,-0.14,0.44,0.055,0.24,(0,math.radians(74),0)); cil("R_Exh3",-1.06,0,0.48,0.055,0.22,(0,math.radians(74),0))
cil("R_Axle",-0.65,0,DR/2,0.045,1.08,(0,math.radians(90),0))
cil("R_BTop",-1.12,0,0.20,0.030,0.96)
cil("R_BArmL",-0.96, 0.44,0.20,0.030,0.28,(0,math.radians(90),0))
cil("R_BArmR",-0.96,-0.44,0.20,0.030,0.28,(0,math.radians(90),0))
bpy.ops.wm.save_as_mainfile(filepath='/opt/blender-runner/outputs/B016.blend')
print('###B010### ok')
