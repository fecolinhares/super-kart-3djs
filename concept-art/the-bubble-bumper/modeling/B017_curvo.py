...
esf("C_Nose",(0.82,0,0.30),0.30,0.20,0.11); suave("C_Nose",2)
...
for sy,sn in ((1,"L"),(-1,"R")):
    esf("SP_"+sn,(-0.20, sy*0.42, 0.36), 0.46,0.16,0.17); suave("SP_"+sn,2)
# ===== BUMPER DIANTEIRO: TORO EM C CONTINUO (corta a metade traseira com boolean) =====
bpy.ops.mesh.primitive_torus_add(major_radius=0.50, minor_radius=0.038, major_segments=40, minor_segments=12,
                                 location=(0.86,0,0.22), rotation=(math.radians(90),0,0))
...
bpy.ops.mesh.primitive_torus_add(major_radius=0.46, minor_radius=0.030, major_segments=36, minor_segments=10,
                                 location=(-1.02,0,0.20), rotation=(math.radians(90),0,0))
...
cil("P_Neck",-0.60,0,0.76,0.055,0.14,(0,0,0)); suave("P_Neck",1)
esf("P_Head",(-0.60,0,0.88),0.150,0.150,0.150); suave("P_Head",1)
for sy,sn in ((1,"L"),(-1,"R")):
    cil("P_Thigh"+sn,-0.02, sy*0.11,0.34,0.075,0.62,(0,math.radians(90),0)); suave("P_Thigh"+sn,1)
    cil("P_Shin"+sn, 0.34, sy*0.11,0.26,0.062,0.42,(0,math.radians(50),0)); suave("P_Shin"+sn,1)
...
bpy.ops.wm.save_as_mainfile(filepath='/opt/blender-runner/outputs/B017.blend')
print('###B017### ok')
