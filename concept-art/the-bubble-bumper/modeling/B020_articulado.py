...
cil("AX_F",0.72,0,R/2,0.035,0.90,(0,math.radians(90),0)); suave("AX_F",1)
cil("W_RL",-0.65,0.53,R,R,0.210); cil("W_RR",-0.65,-0.53,R,R,0.210)
cil("AX_R",-0.65,0,R/2,0.035,1.10,(0,math.radians(90),0)); suave("AX_R",1)
...
box("P_Torso",-0.62,-0.44, -0.17,0.17, 0.34,0.56, rot=(0,math.radians(-45),0)); suave("P_Torso",1)
cil("P_Neck",-0.54,0,0.46,0.080,0.14,(0,math.radians(-30),0)); suave("P_Neck",1)
...
bpy.ops.wm.save_as_mainfile(filepath='/opt/blender-runner/outputs/B020.blend')
print('###B017### ok')
