...
box("C_Nose",0.34,0.92, -0.20,0.20, 0.22,0.42); suave("C_Nose",2); suave("C_Nose",2)
...
for sy,sn in ((1,"L"),(-1,"R")):
    esf("SP_"+sn,(-0.24, sy*0.30, 0.26), 0.42,0.17,0.11); suave("SP_"+sn,2)
...
cil("R_ExhL",-1.02, 0.13,0.44,0.058,0.26,(0,math.radians(72),0)); cil("R_ExhR",-1.02,-0.13,0.44,0.058,0.26,(0,math.radians(72),0))
...
bpy.ops.wm.save_as_mainfile(filepath='/opt/blender-runner/outputs/B022.blend')
print('###B017### ok')
