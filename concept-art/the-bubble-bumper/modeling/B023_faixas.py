...
cil("HUB_FL",0.72, 0.48,R,R*0.40,0.07); cil("HUB_FR",0.72,-0.48,R,R*0.40,0.07)
cil("AX_F",0.72,0,R/2,0.032,0.72,(0,math.radians(90),0)); suave("AX_F",0)
cil("W_RL",-0.65,0.53,R,R,0.210); cil("W_RR",-0.65,-0.53,R,R,0.210)
cil("HUB_RL",-0.65,0.61,R,R*0.40,0.07); cil("HUB_RR",-0.65,-0.61,R,R*0.40,0.07)
...
box("P_Torso",-0.64,-0.42, -0.18,0.18, 0.32,0.66, rot=(0,math.radians(-32),0))
box("P_Shoulder",-0.52,-0.34, -0.26,0.26, 0.54,0.64); suave("P_Torso",1)
capsula("P_Neck",-0.62,-0.46, 0,0.48,0.075, rot=(0,math.radians(-25),0)); suave("P_Neck",0)
...
bpy.ops.wm.save_as_mainfile(filepath='/opt/blender-runner/outputs/B023.blend')
print('###B017### ok')
