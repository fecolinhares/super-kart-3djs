...
for sy,sn in ((1,"L"),(-1,"R")):
    esf("SP_"+sn,(-0.24, sy*0.33, 0.26), 0.40,0.16,0.11); suave("SP_"+sn,2)
...
box("P_Shoulder",-0.50,-0.30, -0.30,0.30, 0.78,0.90); suave("P_Torso",1)
...
bpy.ops.wm.save_as_mainfile(filepath='/opt/blender-runner/outputs/B027.blend')
print('###B017### ok')
