...
esf("R_Motor",(-0.86,0,0.34),0.28,0.24,0.20); suave("R_Motor",2)
...
box("P_Seat",-0.80,-0.66, -0.20,0.20, 0.26,0.56, rot=(0,math.radians(-18),0))
...
bpy.ops.wm.save_as_mainfile(filepath='/opt/blender-runner/outputs/B028.blend')
print('###B017### ok')
