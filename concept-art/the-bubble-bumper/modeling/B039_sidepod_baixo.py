...
bpy.ops.mesh.primitive_torus_add(major_radius=0.54, minor_radius=0.080, major_segments=36, minor_segments=12,
                                 location=(-0.56,0,0.42))
...
bpy.ops.wm.save_as_mainfile(filepath='/opt/blender-runner/outputs/B039.blend')
print('###B017### ok')
