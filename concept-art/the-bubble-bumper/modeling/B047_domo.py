...
for sy,sn in ((1,"L"),(-1,"R")):
    esf("SP_"+sn,(-0.30, sy*0.50, 0.23), 0.54,0.22,0.09); suave("SP_"+sn,2)
# ===== BUMPER DIANTEIRO: TORO EM C CONTINUO (corta a metade traseira com boolean) =====
bpy.ops.mesh.primitive_torus_add(major_radius=0.52, minor_radius=0.075, major_segments=40, minor_segments=14,
...
esf("P_Head",(-0.278, 0.000, 1.210),0.150,0.150,0.150); suave("P_Head",1)
for sy,sn in ((1,"L"),(-1,"R")):
...
bpy.ops.wm.save_as_mainfile(filepath='/opt/blender-runner/outputs/B047.blend')
print('###B017### ok')
