...
bpy.ops.mesh.primitive_torus_add(major_radius=0.62, minor_radius=0.080, major_segments=40, minor_segments=14,
...
bpy.ops.wm.save_as_mainfile(filepath='/opt/blender-runner/outputs/B051.blend')
print('###B017### ok')
