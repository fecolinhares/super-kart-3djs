...
bpy.ops.mesh.primitive_torus_add(major_radius=0.32, minor_radius=0.060, major_segments=36, minor_segments=12,
                                 location=(-0.56,0,0.17))
...
bpy.ops.wm.save_as_mainfile(filepath='/opt/blender-runner/outputs/B055.blend')
print('###B017### ok')
