...
for sy,sn in ((1,"L"),(-1,"R")):
    esf("SP_"+sn,(-0.32, sy*0.42, 0.60), 0.54,0.22,0.155); suave("SP_"+sn,2)
...
esf("R_Motor",(-0.88,0,0.56),0.34,0.26,0.24); suave("R_Motor",2)
...
box("R_Wing",-1.18,-1.02, -0.72,0.72, 0.62,0.78); suave("R_Wing",2)
...
bpy.ops.wm.save_as_mainfile(filepath='/opt/blender-runner/outputs/B071.blend')
print('###B017### ok')
