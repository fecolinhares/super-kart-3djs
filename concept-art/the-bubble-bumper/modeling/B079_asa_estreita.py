...
box("R_Wing",-1.18,-1.02, -0.32,0.32, 1.03,1.18); suave("R_Wing",2)
...
capsula("P_Neck",-0.30,-0.20, 0,0.80,0.080); suave("P_Neck",0)
esf("P_Head",(-0.24,0,0.88),0.160,0.160,0.150); suave("P_Head",1)
for sy,sn in ((1,"L"),(-1,"R")):
...
bpy.ops.wm.save_as_mainfile(filepath='/opt/blender-runner/outputs/B079.blend')
print('###B017### ok')
