...
bpy.ops.mesh.primitive_torus_add(major_radius=0.50, minor_radius=0.085, major_segments=36, minor_segments=12,
                                 location=(-0.72,0,0.24))
...
bpy.ops.wm.save_as_mainfile(filepath='/opt/blender-runner/outputs/B084.blend')
print('###B017### ok')
