...
D=0.53; R=D/2
cil("W_FL",0.72, 0.39,R,R,0.180); cil("W_FR",0.72,-0.39,R,R,0.180)
...
box("R_Fairing",-1.22,-0.60, -0.44,0.44, 0.28,0.62); suave("R_Fairing",1)
...
bpy.ops.wm.save_as_mainfile(filepath='/opt/blender-runner/outputs/B091.blend')
print('###B017### ok')
