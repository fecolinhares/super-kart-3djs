...
cil("W_RL",-0.65,0.50,R,R,0.250); cil("W_RR",-0.65,-0.62,R,R,0.250)
...
box("R_Fairing",-1.22,-0.60, -0.56,0.56, 0.26,0.64); suave("R_Fairing",1)
...
bpy.ops.wm.save_as_mainfile(filepath='/opt/blender-runner/outputs/B093.blend')
print('###B017### ok')
