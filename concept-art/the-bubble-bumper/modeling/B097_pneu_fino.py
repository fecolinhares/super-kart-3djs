...
D=0.53; R=D/2
cil("W_FL",0.72, 0.33,R,R,0.120); cil("W_FR",0.72,-0.33,R,R,0.120)
cil("HUB_FL",0.72, 0.355,R,R*0.40,0.07); cil("HUB_FR",0.72,-0.355,R,R*0.40,0.07)
cil("AX_F",0.72,0,R/2,0.032,0.72,(0,math.radians(90),0)); suave("AX_F",0)
cil("W_RL",-0.65,0.50,R,R,0.150); cil("W_RR",-0.65,-0.50,R,R,0.150)
cil("HUB_RL",-0.65,0.435,R,R*0.40,0.07); cil("HUB_RR",-0.65,-0.435,R,R*0.40,0.07)
...
bpy.ops.wm.save_as_mainfile(filepath='/opt/blender-runner/outputs/B097.blend')
print('###B017### ok')
