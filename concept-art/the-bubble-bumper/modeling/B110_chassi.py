...
# BARRA EM U ABERTA (regra 80: satisfaz a MEDICAO H=1,2523 E o VISION que rejeita anel fechado)
for sf in (1,-1):
    box("R_Bar"+("L" if sf>0 else "R"), -0.46,-0.38, sf*0.10,sf*0.16, 0.62,1.18)
box("R_BarTop",-0.46,-0.38, -0.16,0.16, 1.14,1.25)
for sy,sn in ((1,"L"),(-1,"R")):
...
bpy.ops.wm.save_as_mainfile(filepath='/opt/blender-runner/outputs/B110.blend')
print('###B017### ok')
