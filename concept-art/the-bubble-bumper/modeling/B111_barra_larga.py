...
box("P_Shoulder",-0.50,-0.30, -0.27,0.27, 0.78,0.90)
# BARRA LARGA E BAIXA NA ALTURA DOS OMBROS (concept: travessa da largura do kart + tampoes)
box("C_BarWide",-0.56,-0.46, -0.62,0.62, 0.80,0.88); suave("C_BarWide",1)
for sf2 in (1,-1):
    esf("C_BarCap"+("L" if sf2>0 else "R"),(-0.51, sf2*0.64, 0.84),0.075,0.075,0.045); suave("P_Torso",1)
...
bpy.ops.wm.save_as_mainfile(filepath='/opt/blender-runner/outputs/B111.blend')
print('###B017### ok')
