...
for sy,sn in ((1,"L"),(-1,"R")):
    ...
    box("SP_"+sn, -0.88, 0.12, *sorted((sy*0.30, sy*0.60)), 0.16,0.44); suave("SP_"+sn,1)
    ...
    box("SPC_"+sn, -0.66,-0.10, *sorted((sy*0.30, sy*0.60)), 0.16,0.44)
    ...
    box("SPM_"+sn, -0.84, 0.06, *sorted((sy*0.36, sy*0.54)), 0.42,0.455)
...
bpy.ops.wm.save_as_mainfile(filepath='/opt/blender-runner/outputs/B119.blend')
print('###B017### ok')
