...
for sy,sn in ((1,"L"),(-1,"R")):
    ...
    box("SP_"+sn, -0.92, 0.16, *sorted((sy*0.26, sy*0.64)), 0.13,0.47); suave("SP_"+sn,1)
    ...
    box("SPC_"+sn, -0.70,-0.12, *sorted((sy*0.26, sy*0.64)), 0.13,0.47)
    ...
    box("SPM_"+sn, -0.88, 0.10, *sorted((sy*0.30, sy*0.58)), 0.46,0.49)
...
bpy.ops.wm.save_as_mainfile(filepath='/opt/blender-runner/outputs/B120.blend')
print('###B017### ok')
