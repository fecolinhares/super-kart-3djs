...
D=0.53; R=D/2
RF=R*0.42; cil("W_FL",0.72, 0.52,RF,RF,0.170); cil("W_FR",0.72,-0.52,RF,RF,0.170)
...
RR=R*0.50; cil("W_RL",-0.65,0.58,RR,RR,0.230); cil("W_RR",-0.65,-0.58,RR,RR,0.230)
...
for sy,sn in ((1,"L"),(-1,"R")):
    ...
    box("SP_"+sn, -0.94, 0.18, *sorted((sy*0.20, sy*0.68)), 0.10,0.50); suave("SP_"+sn,1)
...
bpy.ops.wm.save_as_mainfile(filepath='/opt/blender-runner/outputs/B121.blend')
print('###B017### ok')
