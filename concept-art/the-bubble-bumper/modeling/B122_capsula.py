...
D=0.53; R=D/2
RF=R*0.42/0.84; cil("W_FL",0.72, 0.52,RF,RF,0.150); suave("W_FL",1)
...
RR=R*0.50; RR=R*0.50/0.84; cil("W_RL",-0.65,0.58,RR,RR,0.240); suave("W_RL",1)
...
for sy,sn in ((1,"L"),(-1,"R")):
    ...
    capsula("SP_"+sn, -0.86, 0.04, sy*0.44, 0.40, 0.185)
...
bpy.ops.wm.save_as_mainfile(filepath='/opt/blender-runner/outputs/B122.blend')
print('###B017### ok')
