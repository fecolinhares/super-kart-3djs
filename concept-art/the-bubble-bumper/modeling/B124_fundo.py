...
D=0.53; R=D/2
RF=R*0.42/0.84; cil("W_FL",0.72, 0.52,RF*0.9412,RF,0.150); suave("W_FL",1)
cil("W_FR",0.72,-0.52,RF*0.9412,RF,0.150); suave("W_FR",1)
...
RR=R*0.50; RR=R*0.50/0.84; cil("W_RL",-0.65,0.58,RR*0.9412,RR,0.240); suave("W_RL",1)
cil("W_RR",-0.65,-0.58,RR*0.9412,RR,0.240); suave("W_RR",1)
...
bpy.ops.wm.save_as_mainfile(filepath='/opt/blender-runner/outputs/B124.blend')
print('###B017### ok')
