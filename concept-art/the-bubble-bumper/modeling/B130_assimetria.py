...
box("B_Caren",0.58,1.00, -0.62,0.62, 0.20,0.42); suave("B_Caren",2)
box("B_Nose",0.76,1.06, -0.16,0.16, 0.24,0.38); suave("B_Nose",1)
...
esf("R_MotorBlock",(-0.88,0,0.46),0.30,0.24,0.19); suave("R_MotorBlock",1)
...
box("R_Wing",-1.24,-1.06, -0.44,0.44, 0.66,0.78); suave("R_Wing",2)
...
bpy.ops.wm.save_as_mainfile(filepath='/opt/blender-runner/outputs/B130.blend')
print('###B017### ok')
