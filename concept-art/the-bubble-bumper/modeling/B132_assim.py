...
box("R_Wing",-1.30,-1.10, -0.52,0.52, 0.86,0.98); suave("R_Wing",2)
for sf in (1,-1): box("R_Mast"+("L" if sf>0 else "R"),-1.24,-1.16, sf*0.14,sf*0.20, 0.40,0.90); suave("R_Mast"+("L" if sf>0 else "R"),1)
...
bpy.ops.wm.save_as_mainfile(filepath='/opt/blender-runner/outputs/B132.blend')
print('###B017### ok')
