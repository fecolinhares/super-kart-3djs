...
for sy,sn in ((1,"L"),(-1,"R")):
    ...
    capsula("SP_"+sn, -0.82, 0.04, sy*0.44, 0.180, 0.140)
    ...
    capsula("SPM_"+sn, -0.86, 0.08, sy*0.44, 0.175, 0.158)
...
bpy.ops.wm.save_as_mainfile(filepath='/opt/blender-runner/outputs/B137.blend')
print('###B017### ok')
