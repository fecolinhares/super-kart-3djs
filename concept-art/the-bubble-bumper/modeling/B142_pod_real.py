...
for sy,sn in ((1,"L"),(-1,"R")):
    ...
    _pc=pod("SP_"+sn, -0.58, 0.24, sy*0.30,sy*0.58, 0.075,0.335)
    ...
    _ps=pod("SPM_"+sn, -0.62, 0.20, sy*0.275,sy*0.605, 0.030,0.315, chanfro=0.20, bevel=0.026)
    _ps.data.materials.append(bpy.data.materials.new("M_Yellow"))
...
bpy.ops.wm.save_as_mainfile(filepath='/opt/blender-runner/outputs/B139.blend')
print('###B017### ok')
