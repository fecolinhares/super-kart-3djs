...
for _sn,_sy in (("L",1),("R",-1)):
    roda("W_F"+_sn, 0.80, _sy*0.520, 0.30, 0.17)   # dianteira pequena e estreita
    roda("W_R"+_sn,-0.80, _sy*0.560, 0.46, 0.28)   # traseira GRANDE e LARGA (2x volume)
...
for _sn,_sy in (("L",1),("R",-1)):
    cil("C_HubF"+_sn, x=0.80, y=_sy*0.520, z=0.140, r=0.052, d=0.14, rot=(0,math.radians(90),0))
    cil("C_HubR"+_sn, x=-0.80, y=_sy*0.560, z=0.205, r=0.062, d=0.18, rot=(0,math.radians(90),0))
print("###FRENTE### spoiler U + 2 botas amarelas + 5 aletas + nariz + faixa + barra + cubos metal")
bpy.ops.wm.save_as_mainfile(filepath='/opt/blender-runner/outputs/B150.blend')
print('###B017### ok')
