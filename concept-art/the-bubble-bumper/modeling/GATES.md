...
- [ ] G1: QA tecnico aprovado no ultimo build (0 non-manifold, >=95% quads)
  EVIDENCE: pending

- [x] G2: perfil lateral <= 6.0% de erro medio (41 estacoes do contorno superior)
  CHECK: python3 /opt/blender-runner/measure_bb.py w202
...
- [ ] G8: vision confirma grade frontal (5 fendas verticais) e farol visiveis
  EVIDENCE: pending
...
- [ ] G12: vision confirma pneus com banda de rodagem e anel amarelo no aro
  EVIDENCE: pending
...
- [ ] G15: modelo, builder, ficha e provas commitados no repo super-kart-3djs
  EVIDENCE: pending
