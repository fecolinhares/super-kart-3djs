...
ALVO = MD + "authored/conjunto-v170.blend"
...
for tag, loc, rot, sinal in VIEWS:
    ...
    sc.render.filepath = "/tmp/R170_%s.png" % tag
    bpy.ops.render.render(write_still=True)
    print("###R42### render", tag)
for o in bpy.data.objects:
    o.hide_render = False
json.dump({"cx": cx, "cz": cz, "OS": ext * 1.30, "RES": 620, "md5": H_ALVO}, open("/tmp/r170_map.json", "w"))
