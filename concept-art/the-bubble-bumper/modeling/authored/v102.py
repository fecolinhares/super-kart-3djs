...
for _s in (+1, -1):
    cil("R_Spring_%d" % _s, -0.820, _s * 0.285, 0.3400, 0.036, 0.330, rot=(0, 0, 0), m=M_CHROME, v=16)  # v079: VERTICAL (default era deitado) z 0.175..0.505
...
bpy.ops.wm.save_as_mainfile(filepath=MD + "authored/conjunto-v102.blend")
