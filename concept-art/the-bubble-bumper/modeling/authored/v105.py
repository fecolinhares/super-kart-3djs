...
for sgn in (+1, -1):
    cil("Chassis_%d" % sgn, 0.30, sgn * 0.205, 0.235, 0.055, 1.62, rot=(0, math.radians(90), 0), m=M_METAL, v=14, smooth=False)
...
bpy.ops.wm.save_as_mainfile(filepath=MD + "authored/conjunto-v105.blend")
