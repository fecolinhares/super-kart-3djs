...
for sgn in (+1, -1):
    box("F_Pad_%d" % sgn, 0.680, 1.060, sgn * 0.150, sgn * 0.535, 0.030, 0.245, m=M_ACC, bevel=0.030)  # v108: cobre o bow lateralmente  # v074: SECAO larga (vision lia esfera como FAROL)
...
bpy.ops.wm.save_as_mainfile(filepath=MD + "authored/conjunto-v108.blend")
