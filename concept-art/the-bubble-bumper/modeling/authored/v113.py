...
def sec_U(yo, zb, zt, p=0.55):
    ...
    return pts
loft("N_Nose", [
    (1.175, sec_U(0.165, 0.030, 0.185, p=0.88)),  # v072: base desce p/ overlap real com a cinta   # v071: ponta ROMBA vertical (topo 0.185 ~ 0.15 da base)
    (1.145, sec_U(0.158, 0.032, 0.230, p=0.88)),
    (1.070, sec_U(0.148, 0.046, 0.258, p=0.88)),
    (0.960, sec_U(0.142, 0.043, 0.272, p=0.88)),
    (0.840, sec_U(0.148, 0.041, 0.279, p=0.88)),
    (0.780, sec_U(0.145, 0.040, 0.275, p=0.88)),
...
bpy.ops.wm.save_as_mainfile(filepath=MD + "authored/conjunto-v113.blend")
