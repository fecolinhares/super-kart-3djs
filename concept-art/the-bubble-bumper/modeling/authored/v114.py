...
def sec_U(yo, zb, zt, p=0.55):
    ...
    return pts
loft("N_Nose", [
    (1.178, sec_U(0.055, 0.085, 0.190, p=0.88)),
    (1.168, sec_U(0.105, 0.060, 0.235, p=0.88)),
    (1.150, sec_U(0.140, 0.045, 0.275, p=0.88)),
    (1.115, sec_U(0.158, 0.038, 0.305, p=0.88)),
    (1.060, sec_U(0.160, 0.040, 0.325, p=0.88)),
    (0.980, sec_U(0.155, 0.042, 0.325, p=0.88)),
    (0.860, sec_U(0.152, 0.042, 0.320, p=0.88)),
    (0.780, sec_U(0.150, 0.040, 0.275, p=0.88)),
...
bpy.ops.wm.save_as_mainfile(filepath=MD + "authored/conjunto-v114.blend")
