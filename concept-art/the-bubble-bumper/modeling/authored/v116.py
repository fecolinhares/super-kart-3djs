...
loft("N_Nose", [
    ...
    (0.980, sec_U(0.515, 0.042, 0.322, p=0.88)),
    (0.900, sec_U(0.360, 0.042, 0.305, p=0.88)),
    (0.840, sec_U(0.240, 0.041, 0.295, p=0.88)),
...
bpy.ops.wm.save_as_mainfile(filepath=MD + "authored/conjunto-v116.blend")
