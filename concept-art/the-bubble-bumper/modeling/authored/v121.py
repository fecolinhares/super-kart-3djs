...
for (x) in EST:
    ...
    for j in range(n):
        ...
        ztop=0.836-0.018*t+0.026*math.sqrt(max(1.0-(2*t-1)**2,0.0))   # v121: arco ELIPTICO puro (nao achatado no meio)
...
bpy.ops.wm.save_as_mainfile(filepath=MD + "authored/conjunto-v121.blend")
