...
esf("P_Shoulder", tuple(SHO + Vector((0.005, 0, 0.01))), 0.170, 0.222, 0.082, m=M_ACC, seg=20)  # v128: rx 0.140->0.170 e centro +0.025 -> tronco x -0.475..-0.135 = MEDIDO no concept (-0.480..-0.137); antes terminava em -0.195 e o capacete (-0.147) ficava flutuando 0.05 m a frente222
...
bpy.ops.wm.save_as_mainfile(filepath=MD + "authored/conjunto-v128.blend")
