...
_oN = esf("P_Neck", (-0.23, 0.0, 0.945), 0.105, 0.115, 0.072, m=M_SUIT, seg=14)  # v126: era (0.090,0.075,0.055) em z 0.92 -> vao de 2.2 cm entre capacete(z0.938) e ombro(z0.916) lia como cabeca DESLIGADA; agora z 0.873..1.017 atravessa os dois
...
bpy.ops.wm.save_as_mainfile(filepath=MD + "authored/conjunto-v129.blend")
