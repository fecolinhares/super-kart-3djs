...
_oN = esf("P_Neck", (-0.23, 0.0, 0.930), 0.105, 0.115, 0.098, m=M_SUIT, seg=14)  # v130: rz 0.072->0.098 e centro z 0.945->0.930 -> garante interseccao real com o ombro elevado (v129 quebrou o contato Shoulder<->Neck)  # v126: era (0.090,0.075,0.055) em z 0.92 -> vao de 2.2 cm entre capacete(z0.938) e ombro(z0.916) lia como cabeca DESLIGADA; agora z 0.873..1.017 atravessa os dois
...
bpy.ops.wm.save_as_mainfile(filepath=MD + "authored/conjunto-v130.blend")
