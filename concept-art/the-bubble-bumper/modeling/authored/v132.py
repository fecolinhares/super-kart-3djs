...
box("P_SeatBack", -0.520, -0.290, -0.168, 0.168, 0.640, 1.045, m=M_VISL, bevel=0.030)  # v132: -0.400->-0.290 e topo 1.030->1.045. Razao: medicao coluna-a-coluna mostrou o concept CONTINUO em x=-0.33 (0.701..1.089) e x=-0.28 (0.701..1.107), enquanto o modelo tinha vaos; no concept o encosto e uma massa alta e continua atras/lateral do piloto, nao uma chapa atras dele.
...
bpy.ops.wm.save_as_mainfile(filepath=MD + "authored/conjunto-v132.blend")
