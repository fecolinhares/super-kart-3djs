...
esf("P_Shoulder", tuple(SHO + Vector((0.005, 0, 0.075))), 0.170, 0.222, 0.140, m=M_ACC, seg=20)  # v129: centro z +0.065 e rz 0.082->0.140 -> ombro z 0.77..1.05 = MEDIDO no concept (blob azul 0.86<z<1.05 com x -0.480..-0.137); antes topava em 0.916 e deixava 129 mm de vao sob a frente do capacete  # v128: rx 0.140->0.170 e centro +0.025 -> tronco x -0.475..-0.135 = MEDIDO no concept (-0.480..-0.137); antes terminava em -0.195 e o capacete (-0.147) ficava flutuando 0.05 m a frente222
...
bpy.ops.wm.save_as_mainfile(filepath=MD + "authored/conjunto-v133.blend")
