...
box("P_FacePlate", -0.040, 0.010, -0.108, 0.108, 0.995, 1.142, m=M_VILL, bevel=0.010)  # v137: claro/cromado   # v085: recuada (antes cobria os olhos)
...
bpy.ops.wm.save_as_mainfile(filepath=MD + "authored/conjunto-v137.blend")
