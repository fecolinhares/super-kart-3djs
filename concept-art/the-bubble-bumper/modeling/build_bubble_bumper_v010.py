...
OUT=os.path.join(ROOT,'bubble-bumper-v010.blend')
COL=None
MATS={}
...
def create_scene():
    ...
    for j in range(len(deck_sections)-1):
        ...
        # narrow shoulder surfaces continue around the cockpit rim
        dfaces += [(a+1,b+1,b+2,a+2)]
    ...
    # metadata
    sc=bpy.context.scene; sc['asset']='The Bubble Bumper'; sc['revision']='BLOCKOUT_010_AUTHORED_SHELL'; sc['D_tire_m']=.5; sc['source_concept']='concept-art/the-bubble-bumper/assets/the-bubble-bumper.jpg'; sc['custom_channels']='yellow,blue'; sc['visual_gate']='coder_pending'; sc['sol_gate']='pending'; sc['user_gate']='pending'
    return sc
