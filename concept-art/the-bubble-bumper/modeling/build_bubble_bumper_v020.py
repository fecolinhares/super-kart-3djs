...
OUT=os.path.join(ROOT,'bubble-bumper-v020.blend')
COL=None
MATS={}
...
def create_scene():
    ...
    for s in (-1,1):
        ellipsoid('SIDE_POD_YELLOW_L' if s<0 else 'SIDE_POD_YELLOW_R',(s*.47,.00,.45),(.20,.49,.17),MATS['accent_yellow'],24,14)
        ellipsoid('SIDE_POD_BLUE_INSET_L' if s<0 else 'SIDE_POD_BLUE_INSET_R',(s*.47,.02,.51),(.15,.35,.095),MATS['body_blue'],24,12)
    ...
    sc['asset']='The Bubble Bumper'; sc['revision']='BLOCKOUT_020_SMOOTH_CONCEPT_FORMS'; sc['D_tire_m']=.5
