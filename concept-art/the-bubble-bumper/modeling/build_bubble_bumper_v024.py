...
OUT=os.path.join(ROOT,'bubble-bumper-v024.blend')
COL=None
MATS={}
...
def create_scene():
    ...
    for s in (-1,1):
        ...
        box('HEADREST_PAD_L' if s<0 else 'HEADREST_PAD_R',(s*.16,-.30,1.00),(.115,.055,.085),MATS['dark'],.035)
    ...
    sc['asset']='The Bubble Bumper'; sc['revision']='BLOCKOUT_024_HEADREST_MIRROR_INTEGRATION'; sc['D_tire_m']=.5
