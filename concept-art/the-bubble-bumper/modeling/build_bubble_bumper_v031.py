...
OUT=os.path.join(ROOT,'bubble-bumper-v031.blend')
COL=None
MATS={}
...
def create_scene():
    ...
    MATS['concept_ground']=mat('Concept Blueprint Ground',(.72,.74,.76),0.0,.92)
    ...
    for s in (-1,1):
        ...
        box('SIDE_POD_VISIBLE_BLUE_INSET_L' if s<0 else 'SIDE_POD_VISIBLE_BLUE_INSET_R',(s*.725,-.02,.39),(.028,.30,.090),MATS['body_blue'],.035)
    ...
    sc['asset']='The Bubble Bumper'; sc['revision']='BLOCKOUT_031_CONCEPT_PRESENTATION'; sc['D_tire_m']=.5
...
def lights_and_camera():
    ...
    light('KEY',(-3,3,4),1250,5,(1.0,1.0,1.0)); light('FILL',(3,1,2.5),950,4,(.82,.90,1.0)); light('RIM',(0,-4,2.5),700,4,(.95,.95,1.0))
    cams={
