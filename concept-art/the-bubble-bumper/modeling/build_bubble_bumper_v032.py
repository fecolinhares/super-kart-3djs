...
OUT=os.path.join(ROOT,'bubble-bumper-v032.blend')
COL=None
MATS={}
...
def create_scene():
    ...
    MATS['body_blue']=mat('Body Blue',(0.008,0.085,0.48),0.12,.30)
    ...
    sc['asset']='The Bubble Bumper'; sc['revision']='BLOCKOUT_032_CONTRAST_MATERIALS'; sc['D_tire_m']=.5
