...
OUT=os.path.join(ROOT,'bubble-bumper-v035.blend')
COL=None
MATS={}
...
def create_scene():
    ...
    engine=box('REAR_ENGINE',(0,-.70,.58),(.25,.18,.19),MATS['metal'],.085)
    ...
    for s in (-1,1):
        ...
        tube('EXHAUST_L' if s<0 else 'EXHAUST_R',[(s*.20,-.84,.62),(s*.29,-.98,.67),(s*.34,-1.07,.71)],.045,MATS['metal'])
    ...
    sc['asset']='The Bubble Bumper'; sc['revision']='BLOCKOUT_035_COMPACT_REAR_BUMPER'; sc['D_tire_m']=.5
