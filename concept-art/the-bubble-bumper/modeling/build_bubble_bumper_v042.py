...
OUT=os.path.join(ROOT,'bubble-bumper-v042.blend')
COL=None
MATS={}
...
def create_scene():
    ...
    for s in (-1,1):
        ...
        tube('EXHAUST_L' if s<0 else 'EXHAUST_R',[(s*.25,-.91,.64),(s*.30,-1.00,.68),(s*.34,-1.07,.71)],.045,MATS['metal_dark'])
    ...
    sc['asset']='The Bubble Bumper'; sc['revision']='AAA_042_DRIVER_NOSE_REAR_FIDELITY'; sc['D_tire_m']=.5
