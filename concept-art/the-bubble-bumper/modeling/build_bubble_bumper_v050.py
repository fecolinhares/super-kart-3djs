...
OUT=os.path.join(ROOT,'bubble-bumper-v050.blend')
COL=None
MATS={}
...
def create_scene():
    ...
    sc=bpy.context.scene; sc['asset']='The Bubble Bumper'; sc['revision']='AAA_050_ORTHO_REBUILD'; sc['source_concept']='concept-art/the-bubble-bumper/assets/the-bubble-bumper.jpg'; sc['source_orthos']='assets/reference-orthographic/{top,front,rear,side}.jpg'; sc['visual_gate']='pending'; sc['sol_gate']='pending'; sc['user_gate']='pending'
    return sc
