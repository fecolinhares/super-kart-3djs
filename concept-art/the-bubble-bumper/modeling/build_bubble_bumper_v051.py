...
OUT=os.path.join(ROOT,'bubble-bumper-v051.blend')
COL=None
MATS={}
...
def create_scene():
    ...
    ellipsoid('PILOT_SIDE_FACE',(-.155,.05,.90),(.018,.105,.070),MATS['face'],28,18)
    box('PILOT_SIDE_VISOR',(-.178,.07,.88),(.008,.075,.035),MATS['dark'],.010)
    ellipsoid('PILOT_SIDE_EYE',(-.187,.09,.905),(.008,.020,.022),MATS['eye_white'],20,12)
    sphere('PILOT_SIDE_PUPIL',(-.196,.09,.905),.007,MATS['dark'])
