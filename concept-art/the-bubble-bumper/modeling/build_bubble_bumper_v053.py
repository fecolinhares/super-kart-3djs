...
OUT=os.path.join(ROOT,'bubble-bumper-v053.blend')
COL=None
MATS={}
...
def create_scene():
    ...
    box('FRONT_GRILLE',(0,1.30,.30),(.20,.045,.070),MATS['metal_dark'],.025)
    ...
    sc=bpy.context.scene; sc['asset']='The Bubble Bumper'; sc['revision']='AAA_053_ORTHO_P0_CORRECTION'; sc['source_concept']='concept-art/the-bubble-bumper/assets/the-bubble-bumper.jpg'; sc['source_orthos']='assets/reference-orthographic/{top,front,rear,side}.jpg'; sc['visual_gate']='pending'; sc['sol_gate']='pending'; sc['user_gate']='pending'
    return sc
