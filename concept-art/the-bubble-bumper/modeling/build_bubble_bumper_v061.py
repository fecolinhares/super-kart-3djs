...
OUT=os.path.join(ROOT,'bubble-bumper-v061.blend')
COL=None
MATS={}
...
def create_scene():
    ...
    sc=bpy.context.scene; sc['asset']='The Bubble Bumper'; sc['revision']='AAA_061_MANUAL_ORTHO_DETAIL'; sc['source_orthos']='concept-art/the-bubble-bumper/assets/reference-orthographic/{top,front,rear,side}.jpg'; sc['visual_gate']='pending'; sc['sol_gate']='pending'; sc['user_gate']='pending'
    return sc
