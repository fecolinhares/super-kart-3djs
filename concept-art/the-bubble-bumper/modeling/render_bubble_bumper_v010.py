...
blend=os.path.join(JOB,'bubble-bumper-v010.blend')
outdir=os.path.join(JOB,'renders-v010'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V010_RENDERED_'+view)
