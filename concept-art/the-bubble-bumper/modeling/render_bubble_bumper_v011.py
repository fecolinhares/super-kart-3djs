...
blend=os.path.join(JOB,'bubble-bumper-v011.blend')
outdir=os.path.join(JOB,'renders-v011'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V011_RENDERED_'+view)
