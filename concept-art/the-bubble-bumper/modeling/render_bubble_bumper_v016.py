...
blend=os.path.join(JOB,'bubble-bumper-v016.blend')
outdir=os.path.join(JOB,'renders-v016'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V016_RENDERED_'+view)
