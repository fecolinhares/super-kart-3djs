...
blend=os.path.join(JOB,'bubble-bumper-v018.blend')
outdir=os.path.join(JOB,'renders-v018'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V018_RENDERED_'+view)
