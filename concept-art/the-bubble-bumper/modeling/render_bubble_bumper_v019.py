...
blend=os.path.join(JOB,'bubble-bumper-v019.blend')
outdir=os.path.join(JOB,'renders-v019'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V019_RENDERED_'+view)
