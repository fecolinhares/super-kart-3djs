...
blend=os.path.join(JOB,'bubble-bumper-v020.blend')
outdir=os.path.join(JOB,'renders-v020'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V020_RENDERED_'+view)
