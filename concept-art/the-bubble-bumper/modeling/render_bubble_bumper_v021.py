...
blend=os.path.join(JOB,'bubble-bumper-v021.blend')
outdir=os.path.join(JOB,'renders-v021'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V021_RENDERED_'+view)
