...
blend=os.path.join(JOB,'bubble-bumper-v022.blend')
outdir=os.path.join(JOB,'renders-v022'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V022_RENDERED_'+view)
