...
blend=os.path.join(JOB,'bubble-bumper-v023.blend')
outdir=os.path.join(JOB,'renders-v023'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V023_RENDERED_'+view)
