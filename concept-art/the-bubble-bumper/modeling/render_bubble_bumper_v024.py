...
blend=os.path.join(JOB,'bubble-bumper-v024.blend')
outdir=os.path.join(JOB,'renders-v024'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V024_RENDERED_'+view)
