...
blend=os.path.join(JOB,'bubble-bumper-v026.blend')
outdir=os.path.join(JOB,'renders-v026'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V026_RENDERED_'+view)
