...
blend=os.path.join(JOB,'bubble-bumper-v027.blend')
outdir=os.path.join(JOB,'renders-v027'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V027_RENDERED_'+view)
