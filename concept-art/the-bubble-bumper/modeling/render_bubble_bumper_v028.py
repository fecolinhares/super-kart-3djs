...
blend=os.path.join(JOB,'bubble-bumper-v028.blend')
outdir=os.path.join(JOB,'renders-v028'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V028_RENDERED_'+view)
