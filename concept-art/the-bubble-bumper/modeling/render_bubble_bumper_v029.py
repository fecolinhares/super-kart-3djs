...
blend=os.path.join(JOB,'bubble-bumper-v029.blend')
outdir=os.path.join(JOB,'renders-v029'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V029_RENDERED_'+view)
