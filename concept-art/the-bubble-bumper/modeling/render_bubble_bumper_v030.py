...
blend=os.path.join(JOB,'bubble-bumper-v030.blend')
outdir=os.path.join(JOB,'renders-v030'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V030_RENDERED_'+view)
