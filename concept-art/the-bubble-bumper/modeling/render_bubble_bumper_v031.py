...
blend=os.path.join(JOB,'bubble-bumper-v031.blend')
outdir=os.path.join(JOB,'renders-v031'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V031_RENDERED_'+view)
