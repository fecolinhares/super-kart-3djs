...
blend=os.path.join(JOB,'bubble-bumper-v032.blend')
outdir=os.path.join(JOB,'renders-v032'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V032_RENDERED_'+view)
