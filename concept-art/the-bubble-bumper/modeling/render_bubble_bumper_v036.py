...
blend=os.path.join(JOB,'bubble-bumper-v036.blend')
outdir=os.path.join(JOB,'renders-v036'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V036_RENDERED_'+view)
