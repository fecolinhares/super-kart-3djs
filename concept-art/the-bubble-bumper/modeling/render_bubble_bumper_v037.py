...
blend=os.path.join(JOB,'bubble-bumper-v037.blend')
outdir=os.path.join(JOB,'renders-v037'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V037_RENDERED_'+view)
