...
blend=os.path.join(JOB,'bubble-bumper-v038.blend')
outdir=os.path.join(JOB,'renders-v038'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V038_RENDERED_'+view)
