...
blend=os.path.join(JOB,'bubble-bumper-v039.blend')
outdir=os.path.join(JOB,'renders-v039'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V039_RENDERED_'+view)
