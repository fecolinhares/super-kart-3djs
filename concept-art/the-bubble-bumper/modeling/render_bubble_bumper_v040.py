...
blend=os.path.join(JOB,'bubble-bumper-v040.blend')
outdir=os.path.join(JOB,'renders-v040'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V040_RENDERED_'+view)
