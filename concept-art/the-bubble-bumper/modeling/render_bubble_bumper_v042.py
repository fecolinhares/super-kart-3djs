...
blend=os.path.join(JOB,'bubble-bumper-v042.blend')
outdir=os.path.join(JOB,'renders-v042'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V042_RENDERED_'+view)
