...
blend=os.path.join(JOB,'bubble-bumper-v043.blend')
outdir=os.path.join(JOB,'renders-v043'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V043_RENDERED_'+view)
