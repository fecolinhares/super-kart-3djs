...
blend=os.path.join(JOB,'bubble-bumper-v044.blend')
outdir=os.path.join(JOB,'renders-v044'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V044_RENDERED_'+view)
