...
blend=os.path.join(JOB,'bubble-bumper-v045.blend')
outdir=os.path.join(JOB,'renders-v045'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V045_RENDERED_'+view)
