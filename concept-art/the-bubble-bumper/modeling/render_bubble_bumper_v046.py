...
blend=os.path.join(JOB,'bubble-bumper-v046.blend')
outdir=os.path.join(JOB,'renders-v046'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V046_RENDERED_'+view)
