...
blend=os.path.join(JOB,'bubble-bumper-v047.blend')
outdir=os.path.join(JOB,'renders-v047'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V047_RENDERED_'+view)
