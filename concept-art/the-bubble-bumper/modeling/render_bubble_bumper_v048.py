...
blend=os.path.join(JOB,'bubble-bumper-v048.blend')
outdir=os.path.join(JOB,'renders-v048'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V048_RENDERED_'+view)
