...
blend=os.path.join(JOB,'bubble-bumper-v049.blend')
outdir=os.path.join(JOB,'renders-v049'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V049_RENDERED_'+view)
