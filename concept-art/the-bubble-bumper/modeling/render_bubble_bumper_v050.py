...
blend=os.path.join(JOB,'bubble-bumper-v050.blend')
outdir=os.path.join(JOB,'renders-v050'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V050_RENDERED_'+view)
