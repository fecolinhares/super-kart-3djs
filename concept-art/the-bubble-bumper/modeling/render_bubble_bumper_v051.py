...
blend=os.path.join(JOB,'bubble-bumper-v051.blend')
outdir=os.path.join(JOB,'renders-v051'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V051_RENDERED_'+view)
