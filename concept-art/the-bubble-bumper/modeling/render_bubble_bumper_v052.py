...
blend=os.path.join(JOB,'bubble-bumper-v052.blend')
outdir=os.path.join(JOB,'renders-v052'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V052_RENDERED_'+view)
