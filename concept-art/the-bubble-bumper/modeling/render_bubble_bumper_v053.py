...
blend=os.path.join(JOB,'bubble-bumper-v053.blend')
outdir=os.path.join(JOB,'renders-v053'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V053_RENDERED_'+view)
