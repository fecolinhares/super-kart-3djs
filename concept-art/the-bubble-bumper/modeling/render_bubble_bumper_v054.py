...
blend=os.path.join(JOB,'bubble-bumper-v054.blend')
outdir=os.path.join(JOB,'renders-v054'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V054_RENDERED_'+view)
