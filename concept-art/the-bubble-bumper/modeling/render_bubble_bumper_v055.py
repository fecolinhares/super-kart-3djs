...
blend=os.path.join(JOB,'bubble-bumper-v055.blend')
outdir=os.path.join(JOB,'renders-v055'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V055_RENDERED_'+view)
