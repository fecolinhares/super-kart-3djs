...
blend=os.path.join(JOB,'bubble-bumper-v056.blend')
outdir=os.path.join(JOB,'renders-v056'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V056_RENDERED_'+view)
