...
blend=os.path.join(JOB,'bubble-bumper-v057.blend')
outdir=os.path.join(JOB,'renders-v057'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V057_RENDERED_'+view)
