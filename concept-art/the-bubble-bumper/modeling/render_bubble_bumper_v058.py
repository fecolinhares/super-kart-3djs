...
blend=os.path.join(JOB,'bubble-bumper-v058.blend')
outdir=os.path.join(JOB,'renders-v058'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V058_RENDERED_'+view)
