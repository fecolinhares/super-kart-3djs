...
blend=os.path.join(JOB,'bubble-bumper-v059.blend')
outdir=os.path.join(JOB,'renders-v059'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V059_RENDERED_'+view)
