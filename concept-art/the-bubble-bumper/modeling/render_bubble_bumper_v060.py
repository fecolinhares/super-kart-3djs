...
blend=os.path.join(JOB,'bubble-bumper-v060.blend')
outdir=os.path.join(JOB,'renders-v060'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V060_RENDERED_'+view)
