...
blend=os.path.join(JOB,'bubble-bumper-v061.blend')
outdir=os.path.join(JOB,'renders-v061'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V061_RENDERED_'+view)
