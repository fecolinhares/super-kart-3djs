...
blend=os.path.join(JOB,'bubble-bumper-v062.blend')
outdir=os.path.join(JOB,'renders-v062'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V062_RENDERED_'+view)
