...
blend=os.path.join(JOB,'bubble-bumper-v063.blend')
outdir=os.path.join(JOB,'renders-v063'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V063_RENDERED_'+view)
