...
blend=os.path.join(JOB,'bubble-bumper-v064.blend')
outdir=os.path.join(JOB,'renders-v064'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V064_RENDERED_'+view)
