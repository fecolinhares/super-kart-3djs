...
blend=os.path.join(JOB,'bubble-bumper-v065.blend')
outdir=os.path.join(JOB,'renders-v065'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V065_RENDERED_'+view)
