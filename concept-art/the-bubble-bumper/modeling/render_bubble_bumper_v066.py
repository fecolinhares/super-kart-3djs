...
blend=os.path.join(JOB,'bubble-bumper-v066.blend')
outdir=os.path.join(JOB,'renders-v066'); os.makedirs(outdir,exist_ok=True)
view='isometric'
if '--' in sys.argv:
...
print('BUBBLE_BUMPER_V066_RENDERED_'+view)
