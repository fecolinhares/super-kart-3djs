...
def audit_collection(name):
    ...
    for o in meshes:
        ...
        for t in me.loop_triangles:
            a,b,c=(me.vertices[i].co for i in t.vertices); vol+=a.dot(b.cross(c))/6.0
...
def main():
    a=args(); bpy.ops.wm.open_mainfile(filepath=os.path.abspath(a.blend))
    report={"asset":"Super Kart — Hero Kart V2","blend":os.path.abspath(a.blend),"blender":bpy.app.version_string,
    ...
    report["file_size_bytes"]=os.path.getsize(a.blend)
