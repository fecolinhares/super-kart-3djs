// Diag R21y: ?nobl&noinst — isolar bloom E auto-instancing
...
(async () => {
  ...
  await page.goto(process.argv[2] + '/?demo&track=2&nobl&noinst', { waitUntil: 'domcontentloaded', timeout: 120000 });
  ...
  await page.screenshot({ path: '/tmp/r21y.png' });
  console.log('saved');
  await browser.close();
